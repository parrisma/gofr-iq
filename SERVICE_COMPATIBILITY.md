...
All versions must match exactly. See [docs/version_policy.md](docs/version_policy.md) for policy details.
...
1. Update service version in Docker configuration
2. Update corresponding Python library in pyproject.toml
3. Update this table
4. Run integration tests: `./scripts/run_tests.sh`
5. Bump project version in pyproject.toml
