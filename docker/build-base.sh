...
#
# This creates gofr-iq_base:latest by tagging gofr-base:latest
...
TARGET_IMAGE="gofr-iq_base:latest"
...
echo ""
echo "Image size:"
docker images "gofr-iq_base" --format "table {{.Repository}}\t{{.Tag}}\t{{.Size}}"
