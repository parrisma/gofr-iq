#!/bin/bash
# Build GOFR-IQ development image
...
echo "======================================================================="
echo "Building GOFR-IQ Development Image"
echo "======================================================================="
...
echo ""
echo "Building gofr-iq-dev:latest..."
docker build \
    -f "$SCRIPT_DIR/Dockerfile.dev" \
    -t gofr-iq-dev:latest \
    "$PROJECT_ROOT"

echo ""
echo "======================================================================="
echo "Build complete: gofr-iq-dev:latest"
echo "======================================================================="
echo ""
echo "Image size:"
docker images gofr-iq-dev:latest --format "table {{.Repository}}\t{{.Tag}}\t{{.Size}}"
